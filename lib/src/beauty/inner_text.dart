...
class ZegoBeautyPluginInnerText {
  // titles
  String titleFilter;
  String titleFilterNatural;
  String titleFilterGray;
  String titleFilterDreamy;
  String titleBeautify;
  String titleStickers;
  String titleBackground;
  String titleBeautyBasic;
  String titleBeautyAdvanced;
  String titleBeautyMakeup;
  String titleBeautyStyleMakeup;
  ...
  // Beauty - Basic
  String beautyBasicSmoothing;
  String beautyBasicSkinTone;
  String beautyBasicBlusher;
  String beautyBasicSharpening;
  String beautyBasicWrinkles;
  String beautyBasicDarkCircles;

  // Beauty - Advanced
  String beautyAdvancedFaceSlimming;
  String beautyAdvancedEyesEnlarging;
  String beautyAdvancedEyesBrightening;
  String beautyAdvancedChinLengthening;
  String beautyAdvancedMouthReshape;
  String beautyAdvancedTeethWhitening;
  String beautyAdvancedNoseSlimming;
  String beautyAdvancedNoseLengthening;
  String beautyAdvancedFaceShortening;
  String beautyAdvancedMandibleSlimming;
  String beautyAdvancedCheekboneSlimming;
  String beautyAdvancedForeheadSlimming;

  // Beauty - Makeup
  // Beauty - Makeup - Lipstick
  String beautyMakeupLipstick;
  String beautyMakeupLipstickCameoPink;
  String beautyMakeupLipstickSweetOrange;
  String beautyMakeupLipstickRustRed;
  String beautyMakeupLipstickCoral;
  String beautyMakeupLipstickRedVelvet;

  // Beauty - Makeup - Blusher
  String beautyMakeupBlusher;
  String beautyMakeupBlusherSlightlyDrunk;
  String beautyMakeupBlusherPeach;
  String beautyMakeupBlusherMilkyOrange;
  String beautyMakeupBlusherApricotPink;
  String beautyMakeupBlusherSweetOrange;

  // Beauty - Makeup - Eyelashes
  String beautyMakeupEyelashe;
  String beautyMakeupEyelashesNatural;
  String beautyMakeupEyelashesTender;
  String beautyMakeupEyelashesCurl;
  String beautyMakeupEyelashesEverlong;
  String beautyMakeupEyelashesThick;

  // Beauty - Makeup - Eyeliner
  String beautyMakeupEyeliner;
  String beautyMakeupEyelinerNatural;
  String beautyMakeupEyelinerCatEye;
  String beautyMakeupEyelinerNaughty;
  String beautyMakeupEyelinerInnocent;
  String beautyMakeupEyelinerDignified;

  // Beauty - Makeup - Eyeshadow
  String beautyMakeupEyeshadow;
  String beautyMakeupEyeshadowPinkMist;
  String beautyMakeupEyeshadowShimmerPink;
  String beautyMakeupEyeshadowTeaBrown;
  String beautyMakeupEyeshadowBrightOrange;
  String beautyMakeupEyeshadowMochaBrown;

  // Beauty - Makeup - Colored Contacts
  String beautyMakeupColoredContacts;
  String beautyMakeupColoredContactsDarknightBlack;
  String beautyMakeupColoredContactsStarryBlue;
  String beautyMakeupColoredContactsBrownGreen;
  String beautyMakeupColoredContactsLightsBrown;
  String beautyMakeupColoredContactsChocolateBrown;

  // Beauty - Style-Makeup
  String beautyStyleMakeupInnocentEyes;
  String beautyStyleMakeupMilkyEyes;
  String beautyStyleMakeupCutieCool;
  String beautyStyleMakeupPureSexy;
  String beautyStyleMakeupFlawless;

  // Filters
  // Filters - Natural
  String filterNaturalCreamy;
  String filterNaturalBrighten;
  String filterNaturalFresh;
  String filterNaturalAutumn;

  // Filters - Gray
  String filterGrayMonet;
  String filterGrayNight;
  String filterGrayFilmlike;

  // Filters - Dreamy
  String filterDreamySunset;
  ...
  String backgroundMosaicing;
  String backgroundMosaicingTriangle;
  String backgroundMosaicingQuadrangle;
  String backgroundMosaicingHexagon;
  String backgroundGaussianBlur;
